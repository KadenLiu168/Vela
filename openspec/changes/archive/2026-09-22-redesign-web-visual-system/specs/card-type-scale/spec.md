...
**Reason**: A third display-font abstraction conflicts with the Sans-for-language and Mono-for-data architecture.
**Migration**: Card and page titles use `--font-sans`; numeric headlines use `--font-mono`.

### Requirement: Every card visual role maps to exactly one ladder rung
**Reason**: The old requirement and scenario title preserved a retired display-font abstraction.
**Migration**: The new requirement retains all four role mappings using Sans/Mono.
