# strategy-pluggability Specification

## Purpose
Defines the common strategy protocol, registry dispatch, extension boundary, and uniform position contract for pluggable strategies.
## Requirements
